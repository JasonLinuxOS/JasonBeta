...
// Enhanced amnesic mode - clear everything on exit
...
user_pref("privacy.clearOnShutdown.downloads", true);             // Clear download history on exit
user_pref("privacy.clearOnShutdown.formdata", true);              // Clear form data on exit
user_pref("privacy.clearOnShutdown.history", true);               // Clear browsing history on exit
user_pref("privacy.clearOnShutdown.offlineApps", true);           // Clear offline application data
user_pref("privacy.clearOnShutdown.passwords", true);             // Clear saved passwords on exit
user_pref("privacy.clearOnShutdown.sessions", true);              // Clear active logins on exit
user_pref("privacy.clearOnShutdown.siteSettings", true);          // Clear site preferences on exit
...
// DuckDuckGo as new tab page and homepage
user_pref("browser.startup.homepage", "https://duckduckgo.com/");
user_pref("browser.newtabpage.enabled", true);
user_pref("browser.newtab.url", "https://duckduckgo.com/");
user_pref("browser.newtabpage.url", "https://duckduckgo.com/");
user_pref("browser.search.hiddenOneOffs", "Google,Amazon.com,Bing,Yahoo,eBay,Twitter");

// ===== New Identity Features =====
// Force generation of a new identity on startup
user_pref("privacy.resistFingerprinting.randomization.daily_reset.enabled", true);  // Daily reset of randomized data
user_pref("privacy.resistFingerprinting.randomization.enabled", true);              // Enable randomization
user_pref("privacy.resistFingerprinting.letterboxing", true);                      // Enable letterboxing (window size discretization)
user_pref("privacy.resistFingerprinting.autoDeclineNoUserInputCanvasPrompts", true); // Decline canvas access
user_pref("privacy.userContext.enabled", true);                                    // Enable container tabs
user_pref("privacy.userContext.ui.enabled", true);                                 // Enable container UI
